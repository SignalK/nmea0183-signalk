...
describe('VWT', () => {
  ...
  it('speed & direction data (#2)', () => {
    const delta = new Parser().parse(
      '$IIVWT,180.,R,10.1,N,05.2,M,018.7,K*7F'
    ) as any
  ...
  it('speed & direction data (#3)', () => {
    // 190R = 170L
    const delta = new Parser().parse(
      '$IIVWT,190.,R,10.1,N,05.2,M,018.7,K*7E'
    ) as any
  ...
  it('speed & direction data (#4)', () => {
    const delta = new Parser().parse(
      '$IIVWT,170.,L,10.1,N,05.2,M,018.7,K*6E'
    ) as any
  ...
  it('speed & direction data (#5)', () => {
    // 170 + 360 = 530
    const delta = new Parser().parse(
      '$IIVWT,530.,L,10.1,N,05.2,M,018.7,K*6E'
    ) as any
  ...
  it('missing speed data (#1)', () => {
    const delta = new Parser().parse('$IIVWT,030.,R,,N,05.2,M,018.7,*20') as any
  ...
  it('missing speed data (#2)', () => {
    const delta = new Parser().parse('$IIVWT,030.,R,10.1,N,,,018.7,K*21') as any
  ...
  it('missing speed data (#3)', () => {
    const delta = new Parser().parse('$IIVWT,030.,R,10.1,N,,,,K*01') as any
  ...
  it('missing direction data (#1)', () => {
    const delta = new Parser().parse('$IIVWT,,R,10.1,N,,,,K*1C') as any

    should.equal(delta, null)
  })

  it('missing direction data (#2)', () => {
    const delta = new Parser().parse('$IIVWT,0.0,,10.1,N,,,,K*60') as any
  ...
  it('improper direction designator (#1)', () => {
    const delta = new Parser().parse(
      '$IIVWT,030.,r,10.1,N,05.2,M,018.7,K*55'
    ) as any
  ...
  it('improper speed designator (#1)', () => {
    const delta = new Parser().parse(
      '$IIVWT,030.,R,10.1,X,05.2,M,018.7,X*70'
    ) as any
  ...
  it('improper speed designator (#2)', () => {
    const delta = new Parser().parse(
      '$IIVWT,030.,R,10.1,N,05.2,X,018.7,K*60'
    ) as any
  ...
  it('improper speed designator (#3)', () => {
    const delta = new Parser().parse(
      '$IIVWT,030.,R,10.1,X,05.2,X,018.7,X*65'
    ) as any
  ...
  it("Doesn't choke on empty sentences", () => {
    const delta = new Parser().parse('$IIVWT,,,,*55') as any
    should.equal(delta, null)
  })
})
