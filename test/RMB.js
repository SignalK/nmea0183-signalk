...
describe('RMB', () => {
  it('Converts OK using individual parser', (done) => {
    ...
    parser
      .parse('$ECRMB,A,0.000,L,001,002,4653.550,N,07115.984,W,2.505,334.205,0.000,V*04')
      .catch(e => done(e))
  })
  ...
  it('crossTrackError should be positive to steer Right', (done) => {
    ...
    parser
      .parse('$ECRMB,A,0.432,R,001,002,4653.550,N,07115.984,W,2.505,334.205,0.000,V*1F')
      .catch(e => done(e))
  })
  ...
  it('crossTrackError should be negative to steer left', (done) => {
    ...
    parser
      .parse('$ECRMB,A,0.432,L,001,002,4653.550,N,07115.984,W,2.505,334.205,0.000,V*01')
      .catch(e => done(e))
  })
