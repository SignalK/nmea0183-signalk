...
//   - TAG: moment.tz(ms, 'UTC').toISOString() in lib/getTagBlock.ts
//
...
//
// Run from the repo root: npx tsx src/bench/moment.ts [iterations] [trials]
...
function bench(label: string, sentence: string): BenchResult {
