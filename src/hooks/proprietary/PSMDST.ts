...
import seatalkHooks from '../seatalk'
...
const PSMDST: HookFn = function (
  ...
  const hook = seatalkHooks[key]
  if (typeof hook === 'function') {
    return hook(input, session) ?? null
  }
  return null
}

export default PSMDST
module.exports = PSMDST
module.exports.default = PSMDST
