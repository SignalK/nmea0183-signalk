...
module.exports = function (parser, input) {
  ...
  if(parts[0].toUpperCase() == 'V') {
    ...
    return new Error('Not parsing sentence for it\'s void (LORAN-C blink/SNR warning)')
  }

  if(parts[1].toUpperCase() == 'V') {
    return new Error('Not parsing sentence for it\'s void (LORAN-C cycle warning)')
  }
  ...
  return new Error('@FIXME: APB hook needs to be rewritten to fit latest version of SK')
}